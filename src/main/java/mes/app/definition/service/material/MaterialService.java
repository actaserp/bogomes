...
public class MaterialService {
	...
	public int saveMaterial(MultiValueMap<String, Object> data) {
		...
		dicParam.addValue("fiveaxis", CommonUtil.tryIntNull(data.getFirst("fiveaxis")));
		dicParam.addValue("overaxis", CommonUtil.tryIntNull(data.getFirst("overaxis")));
		dicParam.addValue("bodylength", CommonUtil.tryIntNull(data.getFirst("bodylength")));
